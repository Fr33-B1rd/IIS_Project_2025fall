...
def train_classifier(dataset_root: str, test_size=0.2, seed=42, visualize_tsne: bool = True):
    ...
    if visualize_tsne:
        tsne_path = Path("tsne_result.png")
...
if __name__ == "__main__":
    train_classifier(dataset_root="./dataset/mydata", visualize_tsne=True)
